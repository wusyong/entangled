...
enum retcode_t {
  ...
  RC_SQLITE3_FAILED_STEP = 0x0B | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_BEGIN =
      0x0C | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_END = 0x0D | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_MAJOR,
  RC_SQLITE3_FAILED_ROLLBACK =
      0x0E | RC_MODULE_STORAGE_SQLITE3 | RC_SEVERITY_FATAL,
